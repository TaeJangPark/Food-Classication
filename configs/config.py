...
tf.app.flags.DEFINE_string(
    'training_model', './output/training/food_classification.ckpt',
    'Path to checkpoint model')

tf.app.flags.DEFINE_string(
    'checkpoint_model', './output/models/food_classification_final.ckpt',
    'Path to checkpoint model')
...
tf.app.flags.DEFINE_string(
    'TFrecord_dir', 'data/tf_images',
    'The directory of converted TF datas.')
